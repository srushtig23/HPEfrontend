...
class _ForgotPasswordWidgetState extends State<ForgotPasswordWidget> {
  ...
  void initState() {
    ...
    _model.emailIDTextController ??=
        TextEditingController(text: 'Enter your mail address');
            ...
            child: Stack(
              children: [
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 20.0),
                                child: Text(
                                  'We will send you an email with the link\n to reset your password, please enter the email associated with your account below',
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if (_model
                                        .emailIDTextController.text.isEmpty) {
                ...
                if (responsiveVisibility(
                  ...
                  Align(
                    alignment: AlignmentDirectional(-1.07, 1.14),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                ...
                if (responsiveVisibility(
                  ...
                  Align(
                    alignment: AlignmentDirectional(1.0, 1.13),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                ...
                if (responsiveVisibility(
                  ...
                  Align(
                    alignment: AlignmentDirectional(-0.99, 1.07),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/A_group_of_Multiethnic_women_illustration___Premium_AI-generated_image.png',
                ...
                if (responsiveVisibility(
                  ...
                  Align(
                    alignment: AlignmentDirectional(1.01, 1.06),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
                        'assets/images/1safe.png',
